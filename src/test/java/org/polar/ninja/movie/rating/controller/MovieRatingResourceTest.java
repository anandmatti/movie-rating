...
public class MovieRatingResourceTest {

    private static Logger LOGGER = LoggerFactory.getLogger(MovieRatingResourceTest.class);
    ...
    public void testGetRatingsForUser() throws Exception {
        String userId = "1";
        String expectedResponse = "{\"ratingList\":[{\"userId\":\"1\",\"movieId\":\"movie_1\",\"rating\":5},{\"userId\":\"1\"," +
    ...
    public void testGetRatingsForMovie() throws Exception {
        ...
        String expectedResponse = "{\"ratingList\":[{\"userId\":\"user_1\",\"movieId\":\"movie_1\",\"rating\":5},{\"userId\":\"user_2\"," +
